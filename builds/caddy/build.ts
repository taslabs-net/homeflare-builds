 ...
 *   smoke test requires of every build. The house monorepo's Nix module that builds it
 *   (house/nix/homeflare-config/hosts/macmini/modules/edge.nix, `caddy.withPlugins`) pins
 *   the same four, and its generated source is `xcaddy build v2.11.4 --with …` in this order.
 * ★ WHY THIS EXISTS: that Nix build links `/nix/store/…-libresolv-96/lib/libresolv.9.dylib`
